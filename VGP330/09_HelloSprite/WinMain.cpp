...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int)
{
	...
	// Texture
	Texture texture;
	texture.Initialize(L"../../Assets/Images/scv_01.png");
	...
	Coo::Graphics::GraphicsSystem::Get()->SetClearColor(Coo::Graphics::Colors::Cyan);
	...
	while (!done)
	{
		...
		SpriteRenderer::Get()->Draw(texture, { 100.0f,100.0f });
